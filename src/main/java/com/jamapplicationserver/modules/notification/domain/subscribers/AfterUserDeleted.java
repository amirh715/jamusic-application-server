...
import com.jamapplicationserver.modules.user.domain.events.UserDeleted;

/**
 *
 * @author amirhossein
 */
public class AfterUserDeleted implements IHandle<UserDeleted> {
    
    public AfterUserDeleted() {
